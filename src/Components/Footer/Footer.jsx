...
// import logo from "/src/imgs/imgg.png";
...
export default function Footer() {
  return (
    <>
      ...
      <section className="pt-16 pb-7 bg-whitemt-10">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <h1 className="navh min-w-36 text-2xl">Halaa Bazaar</h1>
      <p className= "navb min-w-24"> Online Store</p>
            </NavLink>
        <div className="flex items-center gap-4">
          <a href=""
            className="p-3 rounded-full bg-black text-white group transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white">
      ...
      <div className="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
        <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24">
          <div className="">
          <h1 className="navh min-w-36 mb-7 text-2xl">Halaa Bazaar</h1>
            <ul className="flex flex-col max-lg:items-center gap-6">
              ...
              <li><a href=""
                  className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Categores</a>
              </li>
              <li><a href=""
                  className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Brands</a>
              </li>
              <li><a href=""
                  className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Sale</a></li>
            </ul>
          </div>
          <div className="">
            <h6 className="text-lg font-medium text-black mb-7 max-lg:text-center">Products</h6>
            <ul className="flex flex-col gap-6 max-lg:items-center">
              <li><a href=""
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Clothe</a></li>
              <li><a href=""
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Pants</a></li>
              <li><a href=""
                  ...
                  T-shirts</a></li>
              <li><a href=""
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">male & female</a></li>
            </ul>
          </div>
          <div className="">
            <h6 className="text-lg font-medium text-black mb-7 max-lg:text-center">Resources</h6>
            <ul className="flex flex-col gap-6 max-lg:items-center">
              <li><a href=""
        ...
        <div className="w-full lg:max-w-md max-lg:mx-auto ">
          <h6 className="text-lg font-medium text-black mb-7">Contact</h6>
      ...
      <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
        ...
        <a href="https://pagedone.io/" className="">©HalaaBazaar</a> 2024, All rights reserved.
        </span>
        <div className="relative  text-gray-500 focus-within:text-gray-900 ">
          ...
          <button type="button" id="default-search"
            className="block w-full lg:min-w-[448px] pr-12 pl-6 py-3 text-base font-normal shadow-xs text-black bg-transparent border border-gray-700 rounded-full placeholder-gray-400 focus:outline-none leading-relaxed transition-all duration-500 "
